...
layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "3.0.5 Pro", e = layui.jquery, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show", o = "layim-this", d = 20, r = {}, c = function () {
    ...
    c.prototype.config = function (i) {
        ...
        if (layui.each(Array(5), function (i) {
            ...
            a.unshift(e)
        }), i.skin = a, i = e.extend({isfriend: !0, isgroup: !0, voice: "default.mp3"}, i), window.JSON && window.JSON.parse)return H(i), this
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        return i = i || {}, e.ajax({url: i.url, type: i.type || "get", data: i.data, dataType: i.dataType || "json", cache: !1, success: function (i) {
        ...
        var a = i.init || {};
        return mine = a.mine || {}, local = layui.data("layim")[mine.id] || {}, obj = {base: i, local: local, mine: mine, history: local.history || {}}, create = function (a) {
            var t = a.mine || {}, l = layui.data("layim")[t.id] || {}, s = {base: i, local: l, mine: t, friend: a.friend || [], group: a.group || [], history: l.history || {}};
        ...
        return t.open({type: 1, area: ["260px", "520px"], skin: "layui-box layui-layim", title: "&#8203;", offset: "rb", id: "layui-layim", shade: !1, anim: 2, resize: !1, content: i, success: function (i) {
            ...
            }), a.length > 0 && (a.reverse(), n.html(a.join(""))), A(), ei.sign()
        }, cancel: function (i) {
            T();
        ...
        x.find(".layim-list-history").on("contextmenu", "li", function (a) {
            ...
            n.hasClass("layim-null") || (t.tips(l, this, {tips: 1, time: 0, anim: 5, fixed: !0, skin: "layui-box layui-layim-contextmenu", success: function (i) {
                var a = function (i) {
                    X(i)
                };
        ...
        return b && t.close(b.attr("times")), x && x.hide(), j.mine = j.mine || {}, t.open({type: 1, title: !1, id: "layui-layim-close", skin: "layui-box layui-layim-min layui-layim-close", shade: !1, closeBtn: !1, anim: 2, offset: "rb", resize: !1, content: '<img src="' + (j.mine.avatar || layui.cache.dir + "css/pc/layim/skin/logo.jpg") + '"><span>' + (i || j.base.title || "我的LayIM") + "</span>", move: "#layui-layim-close img", success: function (i, a) {
        ...
        if (a[0]) {
            var s = w.find(".layim-chat-list"), o = s.find(".layim-chatlist-" + i.type + i.id), d = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"), c = a.children(".layim-chat-box");
            return"none" === w.css("display") && w.show(), k && t.close(k.attr("times")), 1 !== s.find("li").length || o[0] || (d || w.css("width", 800), s.css({height: w.height()}).show(), c.css("margin-left", "200px")), o[0] || (s.append(n(v).render(l)), c.append(n(f).render(l)), I()), M(s.find(".layim-chatlist-" + i.type + i.id)), o[0] || B(), R(i), Z(), C
        }
        l.first = !0;
        var u = C = t.open({type: 1, area: "600px", skin: "layui-box layui-layim-chat", id: "layui-layim-chat", title: "&#8203;", shade: !1, maxmin: !0, offset: i.offset || "auto", anim: i.anim || 0, closeBtn: !j.base.brief && 1, content: n('<ul class="layui-unselect layim-chat-list">' + v + '</ul><div class="layim-chat-box">' + f + "</div>").render(l), success: function (a) {
            w = a, a.css({"min-width": "500px", "min-height": "420px"}), "function" == typeof i.success && i.success(a), Z(), _(a), R(i), B(), q(), layui.each(r.chatChange, function (i, a) {
                a && a(O())
            }), a.on("dblclick", ".layui-layim-photos", function () {
                var i = this.src;
                t.close(z.photosIndex), t.photos({photos: {data: [
                    {alt: "大图模式", src: i}
                ]}, shade: .01, closeBtn: 2, anim: 0, resize: !1, success: function (i, a) {
                    z.photosIndex = a
                }})
            })
        }, full: function (i) {
            t.style(u, {width: "100%", height: "100%"}, !0), I()
        }, resizing: I, restore: I, min: function () {
            return E(), !1
        }, end: function () {
        ...
        w && !i && w.hide(), t.close(E.index), E.index = t.open({type: 1, title: !1, skin: "layui-box layui-layim-min", shade: !1, closeBtn: !1, anim: a.anim || 2, offset: "b", move: "#layui-layim-min", resize: !1, area: ["182px", "50px"], content: '<img id="layui-layim-min" src="' + a.avatar + '"><span>' + a.name + "</span>", success: function (a, l) {
        ...
        return i = i || {}, t.close(N.index), N.index = t.open({type: 1, area: "430px", title: {friend: "添加好友", group: "加入群组"}[i.type] || "", shade: !1, resize: !1, btn: a ? ["确认", "取消"] : ["发送申请", "关闭"], content: n(p).render({data: {name: i.username || i.groupname, avatar: i.avatar, group: i.group || parent.layui.layim.cache().friend || [], type: i.type}, type: a}), yes: function (e, t) {
        ...
        var n = i.index() === -1 ? 0 : i.index(), l = ".layim-chat", d = w.find(l).eq(n), c = w.find(".layui-layer-max").hasClass("layui-layer-maxmin");
        if (a) {
        ...
        i.css({"background-image": e ? "url(" + e + ")" : function () {
        ...
        var i = {username: j.mine ? j.mine.username : "访客", avatar: j.mine ? j.mine.avatar : layui.cache.dir + "css/pc/layim/skin/logo.jpg", id: j.mine ? j.mine.id : null, mine: !0}, a = O(), e = a.elem.find(".layim-chat-main ul"), l = j.base.maxLength || 3e3;
        if (i.content = a.textarea.val(), "" !== i.content.replace(/\s/g, "")) {
            if (i.content.length > l)return t.msg("内容最长不能超过" + l + "个字符");
            e.append(n(h).render(i));
            var s = {mine: i, to: a.data}, o = {username: s.mine.username, avatar: s.mine.avatar, id: s.to.id, type: s.to.type, content: s.mine.content, timestamp: (new Date).getTime(), mine: !0};
            V(o), layui.each(r.sendMessage, function (i, a) {
                a && a(s)
            })
        }
        ...
        if (i.timestamp = i.timestamp || (new Date).getTime(), i.fromid == j.mine.id && (i.mine = !0), i.system || V(i), G = JSON.parse(JSON.stringify(i)), j.base.voice && J(), !w && i.content || l === -1) {
            ...
            }), !i.system)return j.base.notice && $({title: "来自 " + i.username + " 的消息", content: i.content, avatar: t.avatar || i.avatar}), E({name: "收到新消息", avatar: t.avatar || i.avatar, anim: 6})
        }
        if (w) {
            var d = O();
    ...
    }, Y = "layui-anim-loop layer-anim-05", F = function (i) {
        ...
        if (!a) {
            var s = n(u({type: i.type, item: "d.data", index: "friend" === i.type ? "data.groupIndex" : null})).render({data: e});
            if ("friend" === i.type) {
    ...
    }, ai = "layui-anim-upbit", ei = {status: function (i, a) {
        var t = function () {
        ...
        i.next()["true" === a ? "removeClass" : "addClass"](s), t["spread" + i.parent().index()] = e, layui.data("layim", {key: j.mine.id, value: t}), i.attr("lay-type", e), i.find(".layui-icon").html("true" === e ? "&#xe61a;" : "&#xe602;")
    }, search: function (i) {
        ...
        return t.close(ei.msgbox.index), i.find("span").removeClass(Y).html(""), ei.msgbox.index = t.open({type: 2, title: "消息盒子", shade: !1, maxmin: !0, area: ["600px", "520px"], skin: "layui-box layui-layer-border", resize: !1, content: j.base.msgbox})
    }, find: function () {
        return t.close(ei.find.index), ei.find.index = t.open({type: 2, title: "查找", shade: !1, maxmin: !0, area: ["1000px", "520px"], skin: "layui-box layui-layer-border", resize: !1, content: j.base.find})
    }, skin: function () {
        t.open({type: 1, title: "更换背景", shade: !1, area: "300px", skin: "layui-box layui-layer-border", id: "layui-layim-skin", zIndex: 66666666, resize: !1, content: n(m).render({skin: j.base.skin})})
    }, about: function () {
        ...
        i.data("down") ? l() : (n.html("&#xe619;"), i.data("down", !0), ei.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {tips: 3, time: 0, anim: 5, fixed: !0, skin: "layui-box layui-layim-members", success: function (a) {
            var t = j.base.members || {}, n = O(), s = a.find(".layim-members-list"), o = "", d = {}, c = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"), u = "none" === w.find(".layim-chat-list").css("display");
        ...
        n = '<ul class="layui-clear layim-face-list">' + n + "</ul>", ei.face.index = t.tips(n, i, {tips: 1, time: 0, fixed: !0, skin: "layui-box layui-layim-face", success: function (i) {
            i.find(".layim-face-list>li").on("mousedown", function (i) {
                X(i)
            }).on("click", function () {
//                ii(l.textarea[0], "face" + this.title + " "), t.close(ei.face.index)
                ii(l.textarea[0], this.innerHTML), t.close(ei.face.index)
            })
        ...
        var a = i.data("type") || "images", e = {images: "uploadImage", file: "uploadFile"}, n = O(), l = j.base[e[a]] || {};
        layui.upload({url: l.url || "",
            method: l.type, elem: i.find("input")[0], unwrap: !0, type: a, success: function (i) {
        ...
        var a = i.data("type"), n = {audio: "音频", video: "视频"}, l = O();
        t.prompt({title: "请输入网络" + n[a] + "地址", shade: !1, offset: [i.offset().top - e(window).scrollTop() - 158 + "px", i.offset().left + "px"]}, function (i, e) {
            ii(l.textarea[0], a + "[" + i + "]"), D(), t.close(e)
        })
    }, extend: function (i) {
        ...
        return e.play ? (t.close(ei.playVideo.index), void(ei.playVideo.index = t.open({type: 1, title: "播放视频", area: ["460px", "300px"], maxmin: !0, shade: !1, content: '<div style="background-color: #000; height: 100%;"><video style="position: absolute; width: 100%; height: 100%;" src="' + a + '" loop="loop" autoplay="autoplay"></video></div>'}))) : t.msg("您的浏览器不支持video")
    }, chatLog: function (i) {
        var a = O();
        return j.base.chatLog ? (t.close(ei.chatLog.index), ei.chatLog.index = t.open({type: 2, maxmin: !0, title: "与 " + a.data.name + " 的聊天记录", area: ["450px", "100%"], shade: !1, offset: "rb", skin: "layui-box", anim: 2, id: "layui-layim-chatlog", content: j.base.chatLog + "?id=" + a.data.id + "&type=" + a.data.type})) : t.msg("未开启更多聊天记录")
    }, menuHistory: function (i, a) {
        var n = layui.data("layim")[j.mine.id] || {}, l = i.parent(), s = i.data("type"), o = x.find(".layim-list-history"), d = '<li class="layim-null">暂无历史会话</li>';
        if ("one" === s) {
            var r = n.history;
            delete r[l.data("index")], n.history = r, layui.data("layim", {key: j.mine.id, value: n}), e("#" + l.data("id")).remove(), 0 === o.find("li").length && o.html(d)
        } else"all" === s && (delete n.history, layui.data("layim", {key: j.mine.id, value: n}), o.html(d));
        t.closeAll("tips")
    }};
    i("layim", new c)
}).addcss("modules/layim/layim.css?v=3.05Pro", "skinlayimcss");